...
export default function AboutPage() {
  ...
  const sectionCards = [
    ...
    },
    {
      delay: 0.16,
      heading:
        "What Makes Neural Linkz Different? Premium Liquid Glass + Bubble Animations on ICP",
      ...
      >
        ...
        >
          ...
          >
            ...
            Llama, and the best open source models. Fully onchain at{" "}
            <a
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(24,214,214,0.4), transparent)",
          }}
        />
