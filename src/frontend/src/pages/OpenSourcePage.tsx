...
import { OS_CATEGORIES, OS_MODELS } from "../data";
import type { OSCategory, OSModel } from "../types";
...
const OSModelCard = React.memo(function OSModelCard({
  model,
  index,
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: 12, color: "#A7ADB7", margin: "2px 0 0" }}>
          {model.developer}
        </p>
      </div>
      <p
