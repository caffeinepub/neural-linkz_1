...
function NeuralNexusOrb({
  onOpen,
  isSheetOpen,
}: { onOpen: (rect: DOMRect) => void; isSheetOpen?: boolean }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Inflation ripple rings - fire as sheet bubbles up */}
        {isInflating && (
          <>
            {/* Glow burst - radial fill */}
            <div
              style={{
                position: "absolute",
                top: "50%",
        ...
        {/* Orb container with breathing + rim animations */}
        <div
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            initial={{ scale: 0.08, borderRadius: "9999px", opacity: 0 }}
            ...
            transition={{
              ...
              damping: 26,
              mass: 0.85,
              opacity: { delay: 0.18, duration: 0.15, ease: "easeOut" },
            }}
            style={{
              position: "fixed",
              left: 0,
  ...
  const faqItems = [
    {
      ...
      a: "Neural Linkz is a decentralized AI directory — like Linktree but for AI models. It features Grok by xAI, Claude, Gemini, Llama, and open source models categorized by text, image, video, and voice generation. It runs fully onchain on the Internet Computer (ICP), built with Caffeine.ai.",
    },
    {
      q: "Is it free and decentralized?",
      a: "Yes. Neural Linkz is completely free to use and runs entirely on the Internet Computer blockchain — no centralized servers, no downtime, fully unstoppable. Hosted and served directly from onchain canisters via Caffeine.ai.",
    },
    {
      q: "How do I install the PWA?",
      a: "Open Neural Linkz in Chrome or Safari on your phone. Tap the share icon and select 'Add to Home Screen', or tap the install prompt. Once installed it launches full-screen like a native app — fast and offline-ready.",
    },
  ];
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="w-full rounded-3xl p-8 md:p-12 mb-6 flex flex-col items-center"
          style={{
            background: "rgba(255,255,255,0.04)",
            backdropFilter: "blur(30px)",
            WebkitBackdropFilter: "blur(30px)",
        ...
        >
          ...
          >
            Neural Linkz —{" "}
            <span style={{ color: "#18D6D6" }}>Decentralized AI Directory</span>{" "}
            on ICP built using caffeine.ai
          </h1>
          <p
            className="text-base md:text-lg leading-relaxed"
            style={{ color: "rgba(255,255,255,0.55)", maxWidth: 520 }}
          >
            The AI directory like Linktree — but for Grok, Claude, Gemini,
            Llama, and the best open source models on ICP. Fully onchain,
            mobile-first, installable PWA.
          </p>
        </motion.div>

        {/* Section: Why Neural Linkz */}
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
        ...
        >
          ...
          >
            Neural Linkz is a premium AI directory PWA featuring Grok by xAI at
            the top, followed by Claude, Gemini, Llama, Perplexity, DeepSeek,
            and more. Think of it as your curated gateway to every major AI
            model — all in one beautifully designed, fully onchain app.
          </p>
        </motion.div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, rgba(24,214,214,0.3), transparent)",
          }}
        />

        {/* Section: Built for the Future */}
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
        ...
        >
          ...
          >
            Fully onchain PWA built with Caffeine.ai — mobile-first,
            installable, liquid glass design. Hosted entirely on the Internet
            Computer Protocol with no servers, no downtime, and no central point
            of failure. Real-time benchmarks, open source models categorized by
            text, image, video, and voice — with Grok featured front and center.
          </p>
        </motion.div>
        ...
        {/* Section: Explore the Neural Universe */}
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
          ...
          className="w-full rounded-2xl px-6 py-6 mb-6"
          style={{
            background: "rgba(255,255,255,0.03)",
            backdropFilter: "blur(20px)",
            WebkitBackdropFilter: "blur(20px)",
        ...
        >
          ...
          >
            Tap the glowing Neural Orb at bottom-right to explore Open Source
            Models, live Benchmarks, and Onchain AI Models. Browse 17+ open
            source models from Llama 4, Mistral, Qwen, Gemma, and more — sorted
            by category and linked directly to Hugging Face. Compare ELO scores,
            SWE-bench, GPQA, and ARC-AGI rankings in the sortable Benchmarks
            leaderboard.
          </p>
        </motion.div>
