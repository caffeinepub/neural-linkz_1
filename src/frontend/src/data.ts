...
export const AI_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    name: "GLM-5",
    company: "Zhipu AI",
    desc: "Advanced frontier model from Zhipu AI with strong reasoning.",
    url: "https://chatglm.cn",
    color: "#FF6B35",
    initials: "GL",
    logo: "/assets/uploads/z-icon-019d21fe-c4dd-757b-aa35-2b4dca256c87-1.svg",
  },
  // Coding / Agentic
  {
    id: "cursor",
  ...
  },
  {
    ...
    name: "Claude Code",
    company: "Anthropic",
    desc: "Best for complex agentic coding and software engineering.",
    url: "https://claude.ai",
    color: "#CC785C",
    initials: "CC",
    logo: "/assets/uploads/claude-ai-icon-019d21d9-5604-75eb-b393-5b31129f9f9b-1.webp",
