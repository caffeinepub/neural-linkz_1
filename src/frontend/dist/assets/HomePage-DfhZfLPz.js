import { j as jsxRuntimeExports, R as React, A as AI_MODELS, m as motion, r as reactExports, G as GROK_LOGO, a as GROK_FALLBACK } from "./index-bI1pUuyU.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        ...
        boxShadow: "0 0 18px rgba(24,214,214,0.1), 0 0 36px rgba(24,214,214,0.05), 0 8px 32px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.12)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              AILogoImg,
              {
                ...
                style: {
                  ...
                  boxShadow: logoHovered ? "0 0 8px rgba(255,255,255,0.08), inset 0 0 4px rgba(255,255,255,0.03)" : "none",
                  transition: "border-color 0.2s, box-shadow 0.2s"
                }
              }
            )
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        ...
        boxShadow: "0 0 18px rgba(204,255,0,0.1), 0 0 36px rgba(204,255,0,0.05), 0 8px 32px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.12)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              AILogoImg,
              {
                ...
                style: {
                  ...
                  boxShadow: logoHovered ? "0 0 10px rgba(204,255,0,0.12), inset 0 0 4px rgba(204,255,0,0.05)" : "0 0 4px rgba(204,255,0,0.08)",
                  transition: "border-color 0.2s, box-shadow 0.2s"
                }
              }
            )
