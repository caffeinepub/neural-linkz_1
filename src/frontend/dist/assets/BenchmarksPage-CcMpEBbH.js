import { r as reactExports, j as jsxRuntimeExports, m as motion, b as AnimatePresence } from "./index-BfO8Bss2.js";
...
function ArenaEloChart() {
  ...
  const getPct = (elo) => Math.max(5, Math.min(100, (elo - BASE) / RANGE * 100));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        borderRadius: 20,
        boxShadow: "0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(255,255,255,0.06), 0 0 60px rgba(24,214,214,0.05), inset 0 1px 0 rgba(255,255,255,0.08)",
        padding: "24px",
        marginBottom: 32,
        overflow: "hidden"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: ARENA_ELO_DATA.map((item, i) => {
          const isTop3 = i < 3;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              onMouseEnter: (e) => {
                ...
                if (bar)
                  bar.style.boxShadow = isTop3 ? "0 0 18px rgba(24,214,214,0.75)" : "0 0 14px rgba(255,255,255,0.4)";
              },
              onMouseLeave: (e) => {
                ...
                if (bar)
                  bar.style.boxShadow = isTop3 ? "0 0 10px rgba(24,214,214,0.45)" : "none";
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      ...
                      flexShrink: 0,
                      borderRadius: "50%",
                      background: isTop3 ? "rgba(24,214,214,0.18)" : "rgba(255,255,255,0.07)",
                      border: isTop3 ? "1px solid rgba(24,214,214,0.40)" : "1px solid rgba(255,255,255,0.12)",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, minWidth: 0, padding: "0 2px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      width: "100%",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          ...
                          background: isTop3 ? "linear-gradient(90deg, rgba(24,214,214,0.6), rgba(24,214,214,0.9))" : "linear-gradient(90deg, rgba(255,255,255,0.35), rgba(255,255,255,0.55))",
                          boxShadow: isTop3 ? "0 0 10px rgba(24,214,214,0.45)" : "none",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px 14px" }, children: columns.filter((c) => c.key !== "rank" && c.key !== "model").map((col) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                ) : col.key === "strengths" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      display: "flex",
                    ...
                    children: (Array.isArray(row[col.key]) ? row[col.key] : []).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: pillStyle, children: t }, t))
                  }
                    ...
                    children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "td",
                      {
                        style: {
                          ...
                          whiteSpace: col.key === "strengths" ? "normal" : "nowrap"
                        },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                activeTab === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(ArenaEloChart, {}),
                activeTab !== 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  HighlightCards,
                  {
