import { r as reactExports, j as jsxRuntimeExports, m as motion, b as AnimatePresence } from "./index-qGif_FTe.js";
...
function useBenchmarkData() {
  ...
  const refresh = reactExports.useCallback(async (force = false) => {
    ...
    try {
      ...
      let source = "cached";
      if (r1.status === "fulfilled" && r1.value && r1.value.ok) {
        source = "lmarena";
      } else if (r2.status === "fulfilled" && r2.value && r2.value.ok) {
        source = "artificialanalysis";
      } else if (r3.status === "fulfilled" && r3.value && r3.value.ok) {
        source = "openllm";
      }
