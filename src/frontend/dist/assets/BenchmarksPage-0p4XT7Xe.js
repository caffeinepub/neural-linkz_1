import { r as reactExports, j as jsxRuntimeExports, m as motion, b as AnimatePresence } from "./index-DGll7KGI.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        ...
        boxShadow: "0 8px 32px rgba(0,0,0,0.5), 0 0 40px rgba(24,214,214,0.04), inset 0 1px 0 rgba(255,255,255,0.08)",
        borderRadius: 16,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "Top Models by Chatbot Arena ELO"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#A7ADB7", fontSize: 12 }, children: "March 2026 • Chatbot Arena" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: ELO_CHART_DATA.map((item, i) => {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            background: isTop3 ? "linear-gradient(90deg, rgba(24,214,214,0.35), rgba(24,214,214,0.18))" : "rgba(255,255,255,0.14)",
                            boxShadow: isHovered ? isTop3 ? "0 0 14px rgba(24,214,214,0.45), inset 0 0 8px rgba(24,214,214,0.15)" : "0 0 10px rgba(255,255,255,0.3)" : isTop3 ? "0 0 6px rgba(24,214,214,0.2)" : "none",
                            willChange: "width"
                          }
                        }
                      )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                      ...
                      height: 8,
                      borderRadius: 4,
                      background: "linear-gradient(90deg, rgba(24,214,214,0.35), rgba(24,214,214,0.18))",
                      boxShadow: "0 0 6px rgba(24,214,214,0.2)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#A7ADB7", fontSize: 11 }, children: "Top 3 models" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#A7ADB7", fontSize: 11 }, children: "Other contenders" })
              ] })
            ]
          }
        )
...
const FETCH_INTERVAL_MS = 48 * 60 * 60 * 1e3;
...
function saveDataSnapshot(source) {
  var _a;
  const now = Date.now();
  ...
  const newEntry = {
    storedAt: now,
    source,
    version: (((_a = fresh[fresh.length - 1]) == null ? void 0 : _a.version) ?? 0) + 1
  };
...
function loadLiveCache() {
  try {
    ...
    if (!raw) return null;
    const parsed = JSON.parse(raw);
    if (!(parsed == null ? void 0 : parsed.rows) || !Array.isArray(parsed.rows)) return null;
...
function useBenchmarkData() {
  ...
  const [arenaData, setArenaData] = reactExports.useState(FALLBACK_ARENA_DATA);
  ...
  const refresh = reactExports.useCallback(async (force = false) => {
    ...
    setLoading(true);
    try {
      const FETCH_TIMEOUT = 9e3;
      async function tryParseJSON(res) {
        try {
          const json = await res.json();
          const arr = Array.isArray(json) ? json : Array.isArray(json == null ? void 0 : json.data) ? json.data : Array.isArray(json == null ? void 0 : json.leaderboard) ? json.leaderboard : Array.isArray(json == null ? void 0 : json.models) ? json.models : null;
      ...
      startTransition(() => {
        ...
        if (rowsToUse) {
          const merged = rowsToUse.slice().sort((a, b) => b.elo - a.elo).map((row, i) => {
            ...
            return {
              rank: i + 1,
              model: row.model,
              provider: row.provider || (fallback == null ? void 0 : fallback.provider) || "",
              elo: row.elo,
              gpqa: (fallback == null ? void 0 : fallback.gpqa) ?? "—",
              sweBench: (fallback == null ? void 0 : fallback.sweBench) ?? "—",
              arcAgi: (fallback == null ? void 0 : fallback.arcAgi) ?? "—",
              context: (fallback == null ? void 0 : fallback.context) ?? "—",
              link: (fallback == null ? void 0 : fallback.link) ?? "#"
            };
          });
          ...
          for (const row of merged) {
            ...
            if (prev !== void 0 && Math.abs(prev - row.elo) > 1) {
      ...
      if (cachedRows) {
        const merged = cachedRows.slice().sort((a, b) => b.elo - a.elo).map((row, i) => {
          const fallback = FALLBACK_ARENA_DATA.find(
            (f) => f.model.toLowerCase() === row.model.toLowerCase()
          );
          return {
  ...
  reactExports.useEffect(() => {
    ...
    try {
      ...
      if (saved) {
        const { ts, source } = JSON.parse(saved);
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                activeTab === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(EloBarChart, {})
              ]
            },
            activeTab
          ) }),
