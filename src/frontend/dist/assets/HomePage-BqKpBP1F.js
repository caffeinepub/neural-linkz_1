import { j as jsxRuntimeExports, R as React, A as AI_MODELS, m as motion, r as reactExports, G as GROK_LOGO, a as GROK_FALLBACK } from "./index-DbmHesS-.js";
function AILogoImg({
  src,
  alt,
  fallbackText,
...
const AICard = React.memo(function AICard2({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 sm:gap-3 mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mt-0.5", style: { color: "#A7ADB7" }, children: model.company })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
...
const FeaturedCard = React.memo(function FeaturedCard2() {
  const [logoHovered, setLogoHovered] = reactExports.useState(false);
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: "#A7ADB7" },
                  children: "The premier onchain AI directory — discover, compare, and connect with the world's best AI models."
                }
              )
            ]
          }
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { "data-ocid": "home.page", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-4 md:px-6 pb-16", style: { background: "#000" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturedCard, {}),
