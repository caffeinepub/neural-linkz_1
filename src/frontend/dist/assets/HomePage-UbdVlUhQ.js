import { j as jsxRuntimeExports, R as React, A as AI_MODELS, m as motion, r as reactExports, G as GROK_LOGO, a as GROK_FALLBACK } from "./index-DB0dkklg.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl md:text-3xl font-bold text-white", children: "Grok" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", style: { color: "#A7ADB7" }, children: "by xAI" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base mb-1.5", style: { color: "#A7ADB7" }, children: "Built by xAI — helpful, truthful, maximum truth-seeking. Elon Musk's AI that cuts through the noise." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              AILogoImg,
              {
                ...
                className: "ai-logo w-14 h-14 md:w-24 md:h-24 object-contain rounded-2xl bg-black/30 p-2",
                style: {
                  border: logoHovered ? "1px solid rgba(204,255,0,0.4)" : "1px solid rgba(204,255,0,0.2)",
                  boxShadow: logoHovered ? "0 0 16px rgba(204,255,0,0.2), inset 0 0 8px rgba(204,255,0,0.05)" : "none",
                  transition: "border-color 0.2s, box-shadow 0.2s"
                }
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl md:text-3xl font-bold text-white", children: "Caffeine.ai" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", style: { color: "#A7ADB7" }, children: "by Caffeine" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base mb-1.5", style: { color: "#A7ADB7" }, children: "Build Full-Stack Apps on ICP by Chatting" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs md:text-sm mb-1.5", style: { color: "#A7ADB7" }, children: "The easiest way to create decentralized AI-powered apps on the Internet Computer. Chat → Code → Deploy." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-start shrink-0 w-[calc(100vw-48px)] md:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GrokFeaturedCard, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "snap-start shrink-0 w-[calc(100vw-48px)] md:w-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CaffeineFeaturedCard, {}) })
        ]
      }
    )
  ] });
